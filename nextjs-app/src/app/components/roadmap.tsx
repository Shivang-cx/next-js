...
export default function Roadmap() {
  ...
  const handleClick = (index: React.SetStateAction<number>) => {
    ...
    return (
    <section className='Rodmap-outer py-[150px] bg-[#0f0f11] relative' id="roadmap">
        ...
        <div className="tabsection flex  max-w-[85%] mr-0 ml-auto relative z-[9]">
                <div className={`img-sec flex flex-col w-[40%] mr-[100px] absolute top-[50%] transition ease-in-out duration-300 translate-y-[-50%] ${activeTab === 0 ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className={`img-sec flex flex-col w-[40%] mr-[100px] absolute top-[50%] transition ease-in-out duration-300 translate-y-[-50%] ${activeTab === 1 ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className={`img-sec flex flex-col w-[40%] mr-[100px] absolute top-[50%] transition ease-in-out duration-300 translate-y-[-50%] ${activeTab === 2 ? 'opacity-100' : 'opacity-0'}`}>
                    <Image  className='cust-img w-full' width={500} height={500} src="/images/tab-3.png" alt={'tab-3'} />
                    <p className='mt-[40px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure exercitationem unde, numquam tempora aspernatur tenetur fuga voluptatibus nisi ratione impedit, cupiditate deserunt? Magnam animi unde cupiditate eius voluptatem doloremque id?</p>
                </div>
                <div className={`img-sec flex flex-col w-[40%] mr-[100px] absolute top-[50%] transition ease-in-out duration-300 translate-y-[-50%] ${activeTab === 3 ? 'opacity-100' : 'opacity-0'}`}>
                    <Image  className='cust-img w-full' width={500} height={500} src="/images/tab-4.png" alt={'tab-4'} />
                    <p className='mt-[40px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                </div>
                <div className={`img-sec flex flex-col w-[40%] mr-[100px] absolute top-[50%] transition ease-in-out duration-300 translate-y-[-50%] ${activeTab === 4 ? 'opacity-100' : 'opacity-0'}`}>
                    <Image  className='cust-img w-full' width={500} height={500} src="/images/tab-5.png" alt={'tab-5'} />
                    <p className='mt-[40px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure exercitationem unde, numquam tempora aspernatur tenetur fuga voluptatibus nisi ratione impedit, cupiditate deserunt? Magnam animi unde cupiditate eius voluptatem doloremque id?</p>
                </div>
                <div className={`img-sec flex flex-col w-[40%] mr-[100px] absolute top-[50%] transition ease-in-out duration-300 translate-y-[-50%] ${activeTab === 5 ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className='tab-hading w-[50%] flex flex-col mr-0 ml-auto'>
                    <div className={`heading-wrapper relative py-[50px] pl-[80px] pr-[0] border  border-[#565656] mr-[15px] relative bg-transparent transition ease-in-out duration-300 mb-[15px]  ${activeTab === 0 ? 'border-[#91ff03]' : 'border-[#565656]'}` }>
                    ...
                    <div className={`heading-wrapper relative py-[50px] pl-[80px] pr-[0] border  border-[#565656] mr-[15px] relative bg-transparent transition ease-in-out duration-300 mb-[15px]  ${activeTab === 1 ? 'border-[#91ff03]' : 'border-[#565656]'}` }>
                    ...
                    <div className={`heading-wrapper relative py-[50px] pl-[80px] pr-[0] border  border-[#565656] mr-[15px] relative bg-transparent transition ease-in-out duration-300 mb-[15px]  ${activeTab === 2 ? 'border-[#91ff03]' : 'border-[#565656]'}` }>
                    ...
                    <div className={`heading-wrapper relative py-[50px] pl-[80px] pr-[0] border  border-[#565656] mr-[15px] relative bg-transparent transition ease-in-out duration-300 mb-[15px]  ${activeTab === 3 ? 'border-[#91ff03]' : 'border-[#565656]'}` }>
                    ...
                    <div className={`heading-wrapper relative py-[50px] pl-[80px] pr-[0] border  border-[#565656] mr-[15px] relative bg-transparent transition ease-in-out duration-300 mb-[15px]  ${activeTab === 4 ? 'border-[#91ff03]' : 'border-[#565656]'}` }>
                    ...
                    <div className={`heading-wrapper relative py-[50px] pl-[80px] pr-[0] border  border-[#565656] mr-[15px] relative bg-transparent transition ease-in-out duration-300  ${activeTab === 5 ? 'border-[#91ff03]' : 'border-[#565656]'}`}>
            ...
            <div className="roadmap-left-bg absolute top-[0] left-[0] w-[350px] h-[500px] rounded-full bg-[#2c3f15] blur-[150px] z-[01]"></div>
            <div className="roadmap-left-bg absolute bottom-[0] right-[0] w-[350px] h-[500px] rounded-full bg-[#2c3f15] blur-[150px] z-[0]"></div>
    </section>
    );
}