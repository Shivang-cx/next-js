...
export default function Banner() {
    return (
        <section className='banner-main mt-[-110px] relative' id="home">
            ...
            <h1 className='text-[86px] text-white leading-[86px] text-center'>Next Gen <br/> NFT Avatars</h1>
            <p className='max-w-[630px]  mx-auto mt-[20px] mb-[30px] text-white text-[16px] leading-[26px] flex text-[#d6d6d6] text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sem nam nisl, vitae amet pellentesque. Tristique cursus duis lectus dolor. Et interdum tristique elit elit nisl, eget praesent.</p>
