    ...
    return (
        ...
        <div>
            <div className="Faq-item py-[40px] border-b-[1px] border-[#565656]">
                <div className="heading flex justify-between" onClick={toggleAccordion}>
                ...
                {isOpen && <div className="content transition ease-in-out delay-300 relative">
                    <p className="text-[16px] text-[#d6d6d6] leading-[26px] transition ease-in-out duration-700">
                        {answer}
                    </p>
                </div>}
            </div>
